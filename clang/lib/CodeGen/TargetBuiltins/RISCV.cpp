...
Value *CodeGenFunction::EmitRISCVBuiltinExpr(unsigned BuiltinID,
  ...
  //TrustGaurd enter_untrusted
  case RISCV::BI__builtin_riscv_enter_untrusted:
    ID = Intrinsic::riscv_enter_untrusted;
    break;

  //TrustGaurd exit_untrusted
  case RISCV::BI__builtin_riscv_exit_untrusted:
  ...
  //TrustGaurd get
  case RISCV::BI__builtin_riscv_get_sentry:
    ID = Intrinsic::riscv_get_sentry;
    break;

  //TrustGaurd alert
  case RISCV::BI__builtin_riscv_alert_sentry:
    ID = Intrinsic::riscv_alert_sentry;
    break;
